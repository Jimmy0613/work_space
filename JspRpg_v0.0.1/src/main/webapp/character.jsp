...
<body>
	...
	<div id="gamebox">
		...
		<div id="system">
			...
			&nbsp;&nbsp;<button onclick="location.href='map/m_1.jsp?c_num=<%=Member.loginC1%>&m_id=1&mode=start'">선택하기</button>
			<%
			} else {
			%>
			...
			&nbsp;&nbsp;<button onclick="location.href='map/m_1.jsp?c_num=<%=Member.loginC2%>&m_id=1&mode=start'">선택하기</button>
			<%
			} else if(m.isChar("m_char2")){
			%>
