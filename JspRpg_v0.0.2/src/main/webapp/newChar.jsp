...
<link rel="stylesheet" href="css/start.css?ver=<%=fmt.format(lastModifiedStyle)%>">
...
<body>
	...
	<div id="gamebox">
		...
		<div id="system">
			...
			<%break;
			case 2:%>
					<p id="form_w">&nbsp;<%=m.charProfile("m_char1") %></p>
					&nbsp;&nbsp;<button onclick="location.href='newChar.jsp'">선택하기</button>
			<%break;
			}%>
			</div>
			<div id="c_info">
