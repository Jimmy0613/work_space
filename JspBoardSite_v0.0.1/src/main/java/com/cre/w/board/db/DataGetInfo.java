...
//		findI: for (int i = BoardMain.postNum - 1; i >= findFirstPost(); i--) {
...
//			BoardMain.postNum = preNum;
//			return;
//		} else { //끝까지 다했는데도 다 널이면
//			d.infoPrint("<!> 이전글이 없습니다.");
//			Home.input = "x";
//			return;
//		}
//	}
...
//		int nextNum = 0;
//		int cnt = 0;
//		findI: for (int i = BoardMain.postNum + 1; i <= findLastPost(); i++) {
//			cnt = ds.dbExecuteQueryInt("ifnull(max(post_num),0)", "board_post", "where post_num = " + i);
//			if (cnt != 0) {
...
//		}
//		if (nextNum != 0) {
//			BoardMain.postNum = nextNum;
//			return;
//		} else {
//			d.infoPrint("<!> 다음글이 없습니다.");
//			Home.input = "x";
//			return;
//		}
//	}
...
//		String wrId = ds.dbExecuteQueryStr("wr_id", "board_post", "where post_num = " + BoardMain.postNum);
//		return wrId;
//	}
//	
